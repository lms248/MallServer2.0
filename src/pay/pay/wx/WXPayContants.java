...
public class WXPayContants {
	...
	/** 沙箱的预支付下单地址 */
	private static String prepay_url_sandbox = "https://api.mch.weixin.qq.com/sandbox/pay/unifiedorder";
	/** 订单查询接口地址 */
	...
	public static String getPrepay_url_sandbox() {
		return prepay_url_sandbox;
	}
